...
- **External control (experimental)** — Let an external scheduler drive the heater
  through an intent entity, off by default. See [docs/external-control.md](docs/external-control.md).
